...
export async function refreshUserInfo() {
  return invoke<void>("refresh_userinfo");
}
export async function getConfigText(vip:boolean) {
  return invoke<void>("get_config_text",{ vip });
}
export async function logoutRs() {
  return invoke<void>("logout");
}
export async function getAppleTime() {
  return invoke<string | null>("get_apple_time");
}

export async function disableSystemProxy() {
  return invoke<void>("disable_system_proxy");
}

export async function enableSystemProxy() {
  return invoke<void>("enable_system_proxy");
}
